    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Add lecturehalls</h1>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="{{url('update-lechall/'.$cdb->id)}}" >Edit</a></li>
                              <li><a class="dropdown-item" href="{{url('delete-lechall/'.$cdb->id)}}">Delete</a></li>
                            </ul>
                          </div>
                    </td>
                </tr>
